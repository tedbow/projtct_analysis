...
time parallel --colsep '\t' --timeout 900 "echo \"Analyzing {1}\"; /var/lib/drupalci/workspace/infrastructure/stats/project_analysis/analyzer.sh \"{1}\" \"{2}\" \"{3}\" \"{4}\" \"{%}\" \"{8}\"" :::: /var/lib/drupalci/workspace/projects.tsv 2>&1 > /var/lib/drupalci/workspace/analyzer_output.log
