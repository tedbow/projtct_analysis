...
EOF
composer -q require palantirnet/drupal-rector:0.5.6 --dev
composer -q require drupal/upgrade_status:2.8
...
composer -q require drupalorg_infrastructure/project_analysis_utils --no-progress
composer -q require drush/drush:9.7.2 --no-progress
